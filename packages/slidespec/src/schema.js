...
const REQUIRED_FIELDS = [
  "id", "index", "section", "role", "title", "keyMessage",
  "body", "visualType", "layout", "speakerNotes", "sourceRefs",
];
...
const VALID_VISUAL_TYPES = [
  "none", "image", "icon", "table", "bar-chart", "line-chart",
  "area-chart", "pie-chart", "scatter-chart", "timeline", "process",
  "roadmap", "matrix", "funnel", "pyramid", "architecture",
