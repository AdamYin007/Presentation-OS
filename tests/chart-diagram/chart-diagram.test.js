...
const { renderPptx, generateBuffer } = require(
  path.join(ROOT, "packages/pptx-renderer/src/index.js"),
);
...
async function runTests() {
  ...
  try {
    ...
    assert(
      ...
      `multi-slide: PPTX buffer generated (${buf.length} bytes)`,
    );
